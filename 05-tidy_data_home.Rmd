...
When R is looking for a function with a particular name, it starts at the top of the list and works its way down. As soon as it finds a function with the name you've specified, it stops looking.
