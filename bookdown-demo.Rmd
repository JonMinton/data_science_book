...
=======
The key point to remember is that computers are *fast* but *dumb*, and when you encounter problems and behaviours you don't expect from R, you have to keep this fact in mind, and be very careful in specifying to R exactly what sort of input it should receive, and in exactly what order. 
>>>>>>> a31810dd45b9d218f5913342a4c9add97c3b66af:05-tidy_data_home.Rmd
...
The majority of the time, it is likely you will be loading and saving data using the 
