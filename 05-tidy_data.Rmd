...
If we did not check our pipe each step of the way, and just assumed that the naive conversion of a factor to numbers would work, then we might either not identify the error at all, and make an error in judgement; or we might struggle to identify where in the operation pipeline the error emerged. 
