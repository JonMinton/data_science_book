...
As with most tools, the most appropriate join type depends on the tasks you want to perform. It's important to be aware of how these join types when a key in one table is matched by more than one value in the key of the second table. 
